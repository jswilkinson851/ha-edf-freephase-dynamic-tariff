...
def normalise_slot(slot):
    ...
    return {
        ...
        "value": slot["value"],
        "phase": normalise_phase(slot["phase"]),
...
def format_slot_times(start_raw, end_raw):
...
def icon_for_phase(phase: str) -> str:
...
def find_current_block(all_slots, current_slot):
...
def find_next_phase_block(slots, phase):
    ...
    # Find first slot of the target phase

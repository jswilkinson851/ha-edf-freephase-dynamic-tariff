...
@pytest.mark.asyncio
async def test_coordinator_success(hass, fake_api_url, fake_scan_interval):
    coordinator = EDFCoordinator(hass, fake_api_url, fake_scan_interval)
...
@pytest.mark.asyncio
async def test_coordinator_error(hass, fake_api_url, fake_scan_interval):
    coordinator = EDFCoordinator(hass, fake_api_url, fake_scan_interval)
